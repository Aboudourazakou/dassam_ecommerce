...
<template>
      ...
      <!--Les plus demandees-->
     <v-container class="d-flex mt-0" style="justify-content:center; ">
        <v-container class="container  pt-0 nomobile pl-0 "  style="width:auto;position:relative">
      <!--title-->
       <v-container :style="'background:'+color" class="title d-flex" id="title" style="height:50px;width:1160px;justify-content:left;align-items:center;background:white">
      ...
      <!--end title-->
       <v-container class="products-container  scroll-right white d-flex align-items-space-around pr-0 pl-3 pb-4 pr-0 mt-0 pt-0" style="height:270px;width:1160px;position:relative">
         ...
         <div class="product-wrapper mr-0 ml-0 pr-0 pl-0 pt-0 mb-0 pb-0" style="display:flex;flex-wrap:wrap;position:relative" v-for="product in products">
